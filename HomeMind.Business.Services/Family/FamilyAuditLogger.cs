...
public sealed class FamilyAuditLogger : IFamilyAuditLogger
{
    ...
    private static readonly HashSet<string> AllowedActions = new(StringComparer.Ordinal)
    {
        ...
        FamilyAuditActions.FinanceImport,
        FamilyAuditActions.BillingAccountCreate,
        FamilyAuditActions.BillingPaymentRecord,
        FamilyAuditActions.PetProfileCreate,
        FamilyAuditActions.PetCareEventCreate,
        FamilyAuditActions.PetSupplyUpsert,
        ...
        FamilyAuditActions.TenantMemberRoleChanged,
        FamilyAuditActions.TenantMemberStatusChanged,
        FamilyAuditActions.TenantInvitationCreated,
        FamilyAuditActions.TenantInvitationRevoked,
        FamilyAuditActions.TenantInvitationAccepted,
        FamilyAuditActions.TenantOwnerTransferred,
        FamilyAuditActions.WebNavigationPreferenceUpdated,
        FamilyAuditActions.ConversationCreate,
        FamilyAuditActions.ConversationRename,
        FamilyAuditActions.ConversationDelete,
        ...
        ,FamilyAuditActions.MemoryCandidateAccepted
        ,FamilyAuditActions.MemoryCandidateRejected
    };
    private static readonly HashSet<string> AllowedTargetTypes = new(StringComparer.Ordinal)
    {
        ...
        FamilyAuditTargetTypes.FinanceTransaction,
        FamilyAuditTargetTypes.BillingAccount,
        FamilyAuditTargetTypes.BillingPaymentRecord,
        FamilyAuditTargetTypes.PetProfile,
        FamilyAuditTargetTypes.PetCareEvent,
        FamilyAuditTargetTypes.PetSupply,
        FamilyAuditTargetTypes.ConnectorAuthorization,
        FamilyAuditTargetTypes.TenantMember,
        FamilyAuditTargetTypes.TenantInvitation,
        FamilyAuditTargetTypes.WebNavigationPreference,
        ...
        ,FamilyAuditTargetTypes.MemoryCandidate
        ,FamilyAuditTargetTypes.LearningMemory
    };
