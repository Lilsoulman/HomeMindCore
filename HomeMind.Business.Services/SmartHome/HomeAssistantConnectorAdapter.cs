...
/// <summary>
/// Home Assistant REST Adapter。供应商实体和服务名只停留在本类内，业务层只处理标准化能力。
/// </summary>
public sealed class HomeAssistantConnectorAdapter : IConnectorAdapter
{
    private static readonly JsonSerializerOptions JsonOptions = new(JsonSerializerDefaults.Web);
    private readonly IConnectorSecretResolver _secrets;
    private readonly HomeMindDbContext _db;

    public HomeAssistantConnectorAdapter(IConnectorSecretResolver secrets, HomeMindDbContext db)
    {
        _secrets = secrets;
        _db = db;
    }
    ...
    private static bool TryMapEntity(JsonElement entity, out DiscoveredDevice device)
    {
        ...
        device = new DiscoveredDevice(externalId, name, deviceType, online, JsonSerializer.Serialize(normalizedState, JsonOptions), sampledAt, spaceName, capabilities);
        return true;
    }
