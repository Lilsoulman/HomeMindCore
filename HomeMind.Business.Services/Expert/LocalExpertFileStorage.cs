...
public sealed class LocalExpertFileStorage : IExpertFileStorage
{
    ...
    public async Task CommitObjectAsync(long tenantId, long fileId, string objectKey, long offsetBytes, long sizeBytes, string sha256, CancellationToken cancellationToken = default)
    {
        if (!_enabled) throw new InvalidOperationException("Expert Files 本地存储未启用。");
