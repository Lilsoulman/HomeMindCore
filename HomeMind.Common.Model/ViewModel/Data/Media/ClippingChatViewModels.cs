...
public sealed record ClippingChatRequest(string Message, ClippingChatContext? Context);
...
public sealed record ClippingChatResponse(string Reply, IReadOnlyList<string> Suggestions, ClippingChatContext Context);
