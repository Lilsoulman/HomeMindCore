...
public sealed record ClippingMaterialView(long Id, string FileName, string? ContentType, long FileSize, int? DurationSeconds, int? Width, int? Height, string StoragePath, DateTime CreatedAt);
